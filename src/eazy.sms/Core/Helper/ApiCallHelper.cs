...
//            {
//                { new StringContent("0553771219"), "recipient[]" },
//                { new ByteArrayContent(File.ReadAllBytes("C:\\Users\\cyber\\RiderProjects\\eazy-sms\\samples\\easy.sms.test\\wwwroot\\Template\\Voice\\ringtone.mp3")), "file", Path.GetFileName("C:\\Users\\cyber\\RiderProjects\\eazy-sms\\samples\\easy.sms.test\\wwwroot\\Template\\Voice\\ringtone.mp3") },
//                { new StringContent(""), "voice_id" },
//                { new StringContent("false"), "is_schedule" },
//                { new StringContent(""), "schedule_date" }
//            };
